...
```{r}
# load lyrics data
load('~/GitHub/fall2019-proj1--nazhuo/data/lyrics.RData') 
```
...
```{r export data}
save(dt_lyrics, file="~/GitHub/fall2019-proj1--nazhuo/output/processed_lyrics.RData")
```

###Save as csv.
```{r}
write.csv(dt_lyrics,file = "~/GitHub/fall2019-proj1--nazhuo/output/dt_lyrics.csv")
```
